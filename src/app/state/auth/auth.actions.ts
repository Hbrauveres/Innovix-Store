...
export const loginSuccess = createAction('[Auth] Login Success', props<{ user: UserData, isLogged: boolean }>());
export const loginFailure = createAction('[Auth] Login Failure', props<{ error: any }>());

export const register = createAction('[Auth] Register', props<{ registerUserData: RegisterUserData }>());
export const registerSuccess = createAction('[Auth] Register Success', props<{ user: UserData, isLogged: boolean }>());
